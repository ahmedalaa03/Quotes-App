...
function generateQuote() {
    ...
    previousIndex = index;
    console.log(index);
    document.getElementById("quote").innerHTML = text[index].quote;
    document.getElementById("author").innerHTML ='Author '+ text[index].author;
}
...
//     if (previousIndex == index) { generateQuote(); }
//     else {
//         previousIndex = index;
//         console.log(index);
//         document.getElementById("quote").innerHTML = text[index].quote;
